...
public class ExpandableRecyclerViews extends RecyclerView
{


    public ExpandableRecyclerViews(Context context)
    {
        super(context, null);
        initRecycler();
    }

    public ExpandableRecyclerViews(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initRecycler();
    }

    public ExpandableRecyclerViews(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    static class SavedState implements Parcelable
    {
        ...
        {
            Parcelable superState = in.readParcelable(ExpandableRecyclerViews.class.getClassLoader());
    ...
    public static class SimpleGroupViewHolder extends GroupViewHolder
    {
        ...
        {
            super(View.inflate(context, R.layout.payment_row, null));
