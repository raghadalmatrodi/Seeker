...
public class Emp_SearchByCategoryFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_emp_search_by_c, container, false);
        ...
        recyclerView.addItemDecoration(new com.example.seeker.Search.Emp_SearchByCategoryFragment.GridSpacingItemDecoration(2, dpToPx(10), true));
